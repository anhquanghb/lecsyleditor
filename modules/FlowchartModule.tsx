...
const FlowchartModule: React.FC<Props> = ({ state, updateState, onCourseNavigate }) => {
  ...
  }, [targetCourses, processedEdges, generalInfo.moetInfo.subBlocks, maxSemester, dragBlockState, tempBlockPos]);
      ...
      >
        ...
        >
            ...
            <svg className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
                ...
                {activeBlockId && (
                    generalInfo.moetInfo.subBlocks?.find(sb => sb.id === activeBlockId)?.courseIds.map(cid => {
